...
📝 Note: All transactions are processed through the web app for security`,
  ...
  // Analyst Monitoring
  analyst_urgent_warning: 'Urgent Warning',
  analyst_final_warning: 'Final Warning to Analyst',
  dear_analyst: 'Dear Analyst',
  no_posts_2_days: 'You haven\'t posted any trades for 2 days!',
  you_have_24_hours: 'You have only 24 hours',
  what_will_happen: 'What will happen if you don\'t post a trade',
  account_suspended_auto: 'Your analyst account will be automatically suspended',
  all_subscriptions_cancelled: 'All subscriptions will be cancelled',
  refunds_to_subscribers: 'Refunds to subscribers',
  loss_of_escrow: 'Loss of all your reserved earnings',
  current_subscribers: 'Current Subscribers',
  earnings_at_risk: 'Earnings at Risk',
  solution: 'Solution',
  post_now_to_save_account: 'Post a trade now to save your account!',
  account_suspended_notice: 'Your analyst account has been suspended',
  suspension_reason_no_posts: 'No trades posted for 3 days',
  subscriptions_cancelled_refunded: 'All subscriptions cancelled and amounts refunded to subscribers',
  affected_subscribers: 'Affected subscribers count',
  total_refunded: 'Total amount refunded',
  contact_admin_to_return: 'To return as an analyst, please contact administration',
  subscription_cancelled_notice: 'Subscription Cancellation Notice',
  subscription_cancelled_analyst: 'Your subscription to analyst has been cancelled',
  reason_no_posts_3_days: 'Analyst hasn\'t posted trades for 3 days',
  amount_refunded: 'Amount refunded',
  balance_available: 'Refunded balance is available in your wallet',
  sorry_for_inconvenience: 'Sorry for the inconvenience, we hope you find another suitable analyst',
  daily_escrow_release: 'Daily Escrow Release',
  escrow_released_today: 'Part of daily escrow balance has been released and added to your available balance!',
  amount_released_today: 'Amount released today',
  available_balance: 'Available Balance',
  withdraw_anytime: 'You can withdraw your available balance anytime',
