...
- ✅ **إصلاح حذف حساب المحلل الكامل**: 
  - الآن يتم حذف سجل المستخدم من جدول users بالإضافة إلى جدول analysts
  - يمكن للمحلل إعادة التسجيل بعد الحذف مع صورة البروفايل الجديدة
