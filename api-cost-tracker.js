  ...
  buildAPIRegistry() {
    return {
      ...
      'Google Gemini API': {
        ...
        endpoints: {
          '/v1beta/models/gemini-2.0-flash:generateContent': { weight: 10, cacheable: false, ttl: 0 },
          '/v1beta/models/gemini-2.0-pro-exp:generateContent': { weight: 15, cacheable: false, ttl: 0 }
        },
