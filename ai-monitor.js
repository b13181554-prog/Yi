...
3. فقط إذا كانت حالة الخدمة "unhealthy" أو "error" أو "critical"، يمكنك إرسال تحذير حرج
...
6. **مهم جداً للذاكرة**: استخدم المتوسط المتحرك (avgUsagePercent) وليس القراءة الحالية (currentUsagePercent) لتحديد مشاكل الذاكرة - الارتفاعات المؤقتة طبيعية
7. **عتبات الذاكرة**: فقط أبلغ عن مشكلة حرجة إذا كان avgUsagePercent > 95%، أو مشكلة متوسطة إذا كان > 85%
8. إذا كانت حالة Memory: "healthy"، لا تبلغ عن أي مشاكل ذاكرة مهما كانت القراءات الفردية
