const translations = {
  ar: {
    ...
    warning_message: '⚠️ تنبيه: هذه توصية فنية وليست نصيحة استثمارية. يرجى إدارة المخاطر بحكمة.',
    buy: 'شراء',
    sell: 'بيع',
    hold: 'انتظار',
  ...
  en: {
    ...
    warning_message: '⚠️ Warning: This is a technical recommendation and not investment advice. Please manage risks wisely.',
    buy: 'Buy',
    sell: 'Sell',
    hold: 'Hold',
  ...
  fr: {
    ...
    warning_message: '⚠️ Avertissement: Ceci est une recommandation technique et non un conseil d\'investissement. Veuillez gérer les risques avec sagesse.',
    buy: 'Acheter',
    sell: 'Vendre',
    hold: 'Attendre',
  ...
  es: {
    ...
    warning_message: '⚠️ Advertencia: Esta es una recomendación técnica y no un consejo de inversión. Por favor, gestione los riesgos con prudencia.',
    buy: 'Comprar',
    sell: 'Vender',
    hold: 'Esperar',
  ...
  de: {
    ...
    warning_message: '⚠️ Warnung: Dies ist eine technische Empfehlung und keine Anlageberatung. Bitte verwalten Sie Risiken klug.',
    buy: 'Kaufen',
    sell: 'Verkaufen',
    hold: 'Warten',
  ...
  ru: {
    ...
    warning_message: '⚠️ Предупреждение: Это техническая рекомендация, а не инвестиционный совет. Пожалуйста, управляйте рисками мудро.',
    buy: 'Покупка',
    sell: 'Продажа',
    hold: 'Ожидание',
  ...
  zh: {
    ...
    buy_signals: '🟢 买入信号：',
    sell_signals: '🔴 卖出信号：',
    warning_message: '⚠️ 警告：这是技术建议，不是投资建议。请明智地管理风险。',
    buy: '买入',
    sell: '卖出',
    hold: '持有',
